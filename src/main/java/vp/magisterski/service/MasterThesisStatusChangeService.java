...
public interface MasterThesisStatusChangeService {
    ...
    void addStatus(MasterThesis thesis, MasterThesisStatus status, LocalDateTime date);
    ...
    MasterThesisStatusChange updateStatus(Long statusId,MasterThesis thesis, String note, User user);
